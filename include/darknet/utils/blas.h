...
void axby_cpu(int N, float ALPHA, float BETA, float *X, int INCX, float *Y, int INCY);
...
void axby_ongpu(int N, float ALPHA, float BETA, float *X, int INCX, float *Y, int INCY);
void axby_ongpu_offset(int N, float ALPHA, float BETA, float *X, int OFFX, int INCX, float *Y, int OFFY, int INCY);
