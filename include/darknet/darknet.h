...
LIB_API float *network_predict_verbose(network net, float *input, int verbose);
LIB_API float *network_predict_ptr(network *net, float *input);
LIB_API float *network_predict_ptr_verbose(network *net, float *input, int verbose);
