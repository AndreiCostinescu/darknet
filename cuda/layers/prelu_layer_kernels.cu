...
__global__ void forward_prelu_layer_kernel(int n, int w, int h, int c, int g, float *input, float *weights,
                                           float *output) {
...
extern "C" void forward_prelu_layer_gpu(const layer l, network_state net) {
    ...
    forward_prelu_layer_kernel<<<cuda_gridsize(n), BLOCK>>>(n, l.w, l.h, l.c, l.groups, net.input, l.weights_gpu,
                                                            l.output_gpu);
