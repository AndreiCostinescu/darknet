...
layer make_lstm_layer(int batch, int inputs, int outputs, int steps, int batch_normalize, int verbose) {
    ...
    *(l.uf) = make_connected_layer(batch, steps, inputs, outputs, LINEAR, batch_normalize, verbose);
    l.uf->batch = batch;
    ...
    *(l.ui) = make_connected_layer(batch, steps, inputs, outputs, LINEAR, batch_normalize, verbose);
    l.ui->batch = batch;
    ...
    *(l.ug) = make_connected_layer(batch, steps, inputs, outputs, LINEAR, batch_normalize, verbose);
    l.ug->batch = batch;
    ...
    *(l.uo) = make_connected_layer(batch, steps, inputs, outputs, LINEAR, batch_normalize, verbose);
    l.uo->batch = batch;
    ...
    *(l.wf) = make_connected_layer(batch, steps, outputs, outputs, LINEAR, batch_normalize, verbose);
    l.wf->batch = batch;
    ...
    *(l.wi) = make_connected_layer(batch, steps, outputs, outputs, LINEAR, batch_normalize, verbose);
    l.wi->batch = batch;
    ...
    *(l.wg) = make_connected_layer(batch, steps, outputs, outputs, LINEAR, batch_normalize, verbose);
    l.wg->batch = batch;
    ...
    *(l.wo) = make_connected_layer(batch, steps, outputs, outputs, LINEAR, batch_normalize, verbose);
    l.wo->batch = batch;
